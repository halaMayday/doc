 ...
 */
@Data
@Arguments(action = "get-instances-list")
@MapTo(ListInstanceParam.class)
public class ListInstancesArgumentsBean extends ArgumentsBean {
     ...
     * 兼容项
     */
    @Argument(full = "vcenterpass", hasArgument = true)
